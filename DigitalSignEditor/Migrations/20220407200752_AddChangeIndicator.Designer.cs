...
namespace DigitalSignEditor.Migrations
{
    ...
    [Migration("20220407200752_AddChangeIndicator")]
    partial class AddChangeIndicator
    {
            ...
            modelBuilder.Entity("DigitalSignEditor.Data.Models.Sign", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 4, 7, 15, 7, 52, 223, DateTimeKind.Local).AddTicks(6549),
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 4, 7, 15, 7, 52, 226, DateTimeKind.Local).AddTicks(9451),
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 4, 7, 15, 7, 52, 226, DateTimeKind.Local).AddTicks(9542),
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 4, 7, 15, 7, 52, 226, DateTimeKind.Local).AddTicks(9548),
                            MinimumHeight = 600,
                            MinimumWidth = 800,
