...
namespace DigitalSignEditor.Migrations
{
    ...
    [Migration("20220401195537_CacheInsall")]
    partial class CacheInsall
    {
            ...
            modelBuilder.Entity("DigitalSignEditor.Data.Models.Sign", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 4, 1, 14, 55, 36, 890, DateTimeKind.Local).AddTicks(3281),
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 4, 1, 14, 55, 36, 893, DateTimeKind.Local).AddTicks(5314),
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 4, 1, 14, 55, 36, 893, DateTimeKind.Local).AddTicks(5404),
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 4, 1, 14, 55, 36, 893, DateTimeKind.Local).AddTicks(5409),
                            MinimumHeight = 600,
                            MinimumWidth = 800,
