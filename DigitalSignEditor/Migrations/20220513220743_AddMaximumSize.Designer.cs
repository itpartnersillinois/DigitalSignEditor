...
namespace DigitalSignEditor.Migrations
{
    ...
    [Migration("20220513220743_AddMaximumSize")]
    partial class AddMaximumSize
    {
            ...
            modelBuilder.Entity("DigitalSignEditor.Data.Models.Sign", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 5, 13, 17, 7, 43, 319, DateTimeKind.Local).AddTicks(5021),
                            MaximumSize = 0,
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 5, 13, 17, 7, 43, 322, DateTimeKind.Local).AddTicks(8196),
                            MaximumSize = 0,
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 5, 13, 17, 7, 43, 322, DateTimeKind.Local).AddTicks(8321),
                            MaximumSize = 0,
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 5, 13, 17, 7, 43, 322, DateTimeKind.Local).AddTicks(8328),
                            MaximumSize = 0,
                            MinimumHeight = 600,
                            MinimumWidth = 800,
