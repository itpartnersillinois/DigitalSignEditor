...
namespace DigitalSignEditor.Migrations
{
    ...
    [Migration("20220914153323_AddingDonor")]
    partial class AddingDonor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalSignEditor.Data.Models.CacheItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("MinutesUntilCacheExpires")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalSignEditor.Data.Models.ChangeIndicator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ChangeIndicators");
                });

            modelBuilder.Entity("DigitalSignEditor.Data.Models.Donor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DigitalSignEditor.Data.Models.Sign", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 9, 14, 10, 33, 22, 815, DateTimeKind.Local).AddTicks(2401),
                            MaximumSize = 0,
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 9, 14, 10, 33, 22, 826, DateTimeKind.Local).AddTicks(3757),
                            MaximumSize = 0,
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 9, 14, 10, 33, 22, 826, DateTimeKind.Local).AddTicks(4123),
                            MaximumSize = 0,
                            MinimumHeight = 600,
                            MinimumWidth = 800,
                        ...
                        new
                        {
                            ...
                            Description = "Sample sign used for testing",
                            IsActive = true,
                            LastUpdated = new DateTime(2022, 9, 14, 10, 33, 22, 826, DateTimeKind.Local).AddTicks(4142),
                            MaximumSize = 0,
                            MinimumHeight = 600,
                            MinimumWidth = 800,
            ...
            modelBuilder.Entity("DigitalSignEditor.Data.Models.Slide", b =>
                {
                    ...
                    b.Property<string>("DisplayUrlCompressed")
                        .HasColumnType("nvarchar(max)");
