...
To build the database, run Update-Database in Package Manager Console (see https://docs.microsoft.com/en-us/ef/core/cli/powershell). Note that people, signs, and sign permissions need to be added manually. 
